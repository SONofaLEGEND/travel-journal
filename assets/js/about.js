...
const tripData = {
  INDIA: [
    { place: 'CHENNAI', title: 'Where the roots are', link: 'trips/india-chennai.html' }
  ],
  UAE: [
    { place: 'DUBAI', title: 'A layover that stretched to three days', link: 'trips/uae-dubai.html' }
  ],
  IRELAND: [
    { place: 'DINGLE PENINSULA', title: 'Weather that changes its mind', link: 'trips/ireland-dingle.html' },
    { place: 'DUBLIN', title: 'Home base, most days', link: 'trips/ireland-dublin.html' }
  ],
  'SRI LANKA': [
    { place: 'ELLA', title: 'Tea country, slow trains', link: 'trips/sri-lanka-ella.html' }
  ],
  POLAND: [
    { place: 'KRAKÓW', title: 'Old town, cheap trains', link: 'trips/poland-krakow.html' }
  ],
  CZECH: [
    { place: 'PRAGUE', title: 'Spires and a very good bakery', link: 'trips/czech-prague.html' }
  ],
  AUSTRIA: [
    { place: 'VIENNA', title: 'Coffee houses and quiet grandeur', link: 'trips/austria-vienna.html' }
  ],
  SLOVAKIA: [
    { place: 'BRATISLAVA', title: 'A capital you can walk in an afternoon', link: 'trips/slovakia-bratislava.html' }
  ],
  HUNGARY: [
    { place: 'BUDAPEST', title: 'Thermal baths at closing time', link: 'trips/hungary-budapest.html' }
  ]
};
